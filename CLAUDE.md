...
\*\*절충점:\*\* 이 지침은 속도보다는 신중함을 강조합니다. 간단한 작업의 경우 판단력을 발휘하세요.
...
새 세션이 시작될 때 `context.md` 파일을 읽어 프로젝트 현황과 이전 작업 맥락을 파악하세요.



\- 파일 경로: `vo_rec/context.md`

\- 내용: 구현 완료 기능 목록, 버그 수정 이력, 기술 결정 사항, 미해결 이슈

\- CLAUDE.md 로드 직후, 작업 시작 전에 읽으세요.
